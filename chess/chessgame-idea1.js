...
function HTMLstringForGame(label,width) {
  var out = '';
  out += '<style>.board-' + label + ' { ';
  out += widthStringHTML(width);
  out += ' } </style> ';
  out += '<style>.chessboard { ';
  out += widthStringHTML(width);
  out += ' } </style> ';
  out += '<div class="chessboard" id="' + label + 
             '" style="margin: 0 auto; ';
  out += '"></div> ';
  out += '<div style="margin: 5px auto;'
  out += '"> ';
...
function HTMLstringForPostition(label,width,ply) {
  ...
  out += '<div class="chessboard" id="' + label + 
             '" style="margin: 0 auto;';
  out += '"></div> ';
  out += '<div class="board-' + label + '" style="margin: 5px auto;';
  out += '"> ';
  out += '<input type="button" onclick="chessMove('
      + "'" + label + "'" + ',-6)" value="<" /> ';
  out += '<input type="button" onclick="chessMove('
...
function widthStringHTML(width) {
  var out = "";
  out += ' width: ' + width + 'px; ';
  out += ' @media screen and (min-width: ' + (width + 5) + 'px) {';
  out += 'width: ' + width + 'px !important;} ';
  out += ' @media screen and (max-width: ' + (width + 4) + 'px) {';
