...
`make.blog.sh` is public domain, as are   
`makeBlog.lua`, `makeMaraDNSBlog.lua`, `oneEntry.lua`,  
and `splitBlog.lua`.
...
All files in `AI-summaries` are by and large generated by AI, and, as
such, are public domain.
